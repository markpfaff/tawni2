...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			<button class="menu-toggle" aria-controls="menu" aria-expanded="false"><img src="wp-content/themes/tawnieakman/images/menu.png" alt="Menu Button"/></button>
                        
                        <div id="logo">
                           
                            <a href="<?php echo home_url(); ?>"><img src="wp-content/themes/tawnieakman/images/logo2.png" alt="Tawni Eakman Logo"/></a>
<!--    alt logo placement             
